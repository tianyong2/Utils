...
//		}
	...
	/**
	 * 判断OpenFire用户的状态 strUrl : url格式 - http://my.openfire.com:9090/plugins/presence /status?jid=user1@SERVER_NAME&type=xml 返回值 : 0 - 用户不存在; 1 - 用户在线; 2 - 用户离线 说明 ：必须要求 OpenFire加载
